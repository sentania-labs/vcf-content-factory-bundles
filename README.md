...
| cpu-support-status-dashboard | 2026-07-22 | CPU support/deprecation posture per Broadcom KB 318697 (https://knowledge. | [Download](dashboards/cpu-support-status-dashboard.zip) | `python3 install.py` |
...
|---|---|---|---|---|---|---|---|
| idps-planner-3.5 | 3.5 | 2026-04-27 | vDefend IDPS resource-monitoring dashboard for VCF Operations. | MIT | Ryan Pletka, Brock Peterson, Joe Tietz, Geoff Shukin, Scott Bowe | [Download](ThirdPartyContent/dashboards/idps-planner-3.5.zip) | `python3 install.py` |

## Retired
| Name | Subdir | Retired | Reason | Download |
|---|---|---|---|---|
| synology-diskstation-managementpack.zip | management-packs | 2026-07-07 | stale: no source release manifest | [Download](retired/management-packs/synology-diskstation-managementpack.zip) |
| unifi-controller-managementpack.zip | management-packs | 2026-07-07 | stale: no source release manifest | [Download](retired/management-packs/unifi-controller-managementpack.zip) |
